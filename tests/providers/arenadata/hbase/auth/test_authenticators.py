...
from airflow.providers.arenadata.hbase.auth import AuthenticatorFactory, HBaseAuthenticator, SimpleAuthenticator
from airflow.providers.arenadata.hbase.auth.base import KerberosAuthenticator
...
class TestKerberosAuthenticator:
    ...
    @patch("airflow.providers.arenadata.hbase.auth.base.subprocess.run")
