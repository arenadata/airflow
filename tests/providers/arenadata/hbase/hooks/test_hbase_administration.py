...
class TestHBaseAdministrationHook:
    ...
    @patch("airflow.providers.arenadata.hbase.hooks.hbase_administration.HBaseAdministrationHook.get_connection")
    @patch("airflow.providers.arenadata.hbase.hooks.hbase_administration.subprocess.run")
