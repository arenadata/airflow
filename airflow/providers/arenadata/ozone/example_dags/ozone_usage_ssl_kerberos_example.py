...
authentication enabled. It performs the same operations as ozone_usage_ssl_example.py
...
if _HAS_S3:
    with DAG(
        "ozone_usage_ssl_kerberos_example",
    ...
    with DAG(
        "ozone_usage_ssl_kerberos_example",
        default_args=default_args,
        description="Example DAG: Ozone SSL + Kerberos (requires apache-airflow-providers-amazon)",
        schedule=None,
        start_date=datetime(2024, 1, 1),
        catchup=False,
        tags=["ozone", "example"],
