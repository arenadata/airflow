...
KRB_ADMIN_CONN_ID = _example_env("OZONE_EXAMPLE_KRB_ADMIN_CONN_ID", "ozone_admin_ssl_kerberos")
KRB_VOLUME = _example_env("OZONE_EXAMPLE_KRB_VOLUME", "vol1")
KRB_BUCKET = _example_env("OZONE_EXAMPLE_KRB_BUCKET", "bucket-native")
KRB_DIR = _example_env("OZONE_EXAMPLE_KRB_DIR", "data_dir")
KRB_FILE = _example_env("OZONE_EXAMPLE_KRB_FILE", "file.txt")
